...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Filtr (prefiks buyicha)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Prefiks</th>
            <th onClick={changeReverseProperties}>Xossalar</th>
          </tr>
        </thead>
        <tbody>
